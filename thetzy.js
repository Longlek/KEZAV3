...
//—————「 Set Nama Own & Bot 」—————//
global.ownername = 'Kezaa' //ubah jadi nama mu, note tanda ' gausah di hapus!
global.botname = 'Kezaa Bot' //ubah jadi nama bot mu, note tanda ' gausah di hapus!
global.footer = 'Kezaa' //ubah jadi nama mu, note tanda ' gausah di hapus!
//=================================================//
// Other
...
global.limitawal = {
   ...
   global.rpg = {
   darahawal: 10000000000,
   besiawal: 5000000000000,
   goldawal: 1,
   emeraldawal: 1,
   umpanawal: 1,
   potionawal: 1
